...
public class FindTheBestDeal {
    ...
    public static void main(String[] args) {
        ...
        // deal1 calculations
        double amountWithDeal1 = customerCartTotal * 0.9;  //corrected
        // deal2 calculations
        double amountWithDeal2 = customerCartTotal *0.95 ;  //corrected
        // deal3 calculations
        double amountWithDeal3 = customerCartTotal * 0.7;  //corrected
